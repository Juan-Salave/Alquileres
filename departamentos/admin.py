...
from .models import Barrio, Departamento, ImagenDepartamentos
...
class DepartamentosAdmin(admin.ModelAdmin):
    list_display = ['titulo1', 'barrio', 'clave', 'precio']     # Campos visibles en el admin
    list_editable = ['precio', 'clave']                         # Campos editables    
    search_fields =['titulo1']                                  # Campo de busqueda
